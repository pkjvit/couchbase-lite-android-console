...
public class ReplicationAllAdapter extends RecyclerView.Adapter<ReplicationAllAdapter.MyViewHolder> {

    private List<Replication> mReplicationList;
    private RecyclerViewClickListener mRecyclerViewClickListener;
    private Context mContext;
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        public TextView dbNameTV;
        ...
        public MyViewHolder(View view, RecyclerViewClickListener listener) {
            super(view);
            mListener = listener;
            dbNameTV = (TextView) view.findViewById(R.id.tv_db_name);
    ...
    public ReplicationAllAdapter(Context context, List<Replication> replicationList, RecyclerViewClickListener recyclerViewClickListener) {
        mContext = context;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_replication_all, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.dbNameTV.setText(Html.fromHtml(String.format("<b>%s</b>",replication.getLocalDatabase().getName())));
